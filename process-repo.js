    ...
    try {
      ...
      if (isFolder) {
        ...
        for (const fileOrFolder of filesOrFolders) {
          ...
          if (stats3)
            children.push(stats3);
        }
        const stats2 = await getFileStats(path);
        return { ...stats2, children };
      }
...
var main = async () => {
  ...
  await import_fs2.default.writeFileSync(outputFile, fileStr.replace("$$$DATA$$$", JSON.stringify(data)));
  console.log("All set!");
};
main();
/*!
